...
def test_post_async_transcriptions_api_with_bearer_access_token():
...
def test_get_async_transcription_api_with_bearer_access_token():
    ACCESS_TOKEN_BEARER = 'Bearer ' + ACCESS_TOKEN
    print(ACCESS_TOKEN_BEARER)
...
def test_get_audio_file_transcription_with_bearer_access_token():
    ACCESS_TOKEN_BEARER = 'Bearer ' + ACCESS_TOKEN
    print(ACCESS_TOKEN_BEARER)
    status, response = API_Calls.get_audio_file_transcription(BASE_URL, FILE_PATH_ENCODED_SAVED, ACCESS_TOKEN_BEARER)
    #print(API_Calls.get_audio_file_transcription(BASE_URL, FILE_PATH_ENCODED_SAVED, ACCESS_TOKEN))
    print(FILE_PATH_ENCODED_SAVED)
    print(status, response)
    assert status == 200
...
def test_post_async_transcriptions_api_access_token_with_bearer_in_small_case():
    ACCESS_TOKEN_BEARER1 = 'bearer ' + ACCESS_TOKEN
    print(ACCESS_TOKEN_BEARER1)
    status, data = API_Calls.post_async_transcriptions_api(ASYNC_URL, ASYNC_TRANSCRIPTION_API_DATA, ACCESS_TOKEN_BEARER1,CONTENT_TYPE_APPLICATION_JSON)
    print(status, data)
    assert status == 401
...
def test_get_async_transcriptions_api_with_access_token_bearer_in_small_case():
    ACCESS_TOKEN_BEARER1 = 'bearer ' + ACCESS_TOKEN
    print(ACCESS_TOKEN_BEARER1)
    status, data = API_Calls.get_async_transcription_api(ASYNC_URL, ACCESS_TOKEN_BEARER1, str(get_job_id))
    print(status, data)
    assert status == 401
...
def test_get_audio_file_transcription_api_access_token_with_bearer_in_small_case():
    ACCESS_TOKEN_BEARER1 = 'bearer ' + ACCESS_TOKEN
    print(ACCESS_TOKEN_BEARER1)
    status, data = API_Calls.get_audio_file_transcription(BASE_URL, FILE_PATH_ENCODED,ACCESS_TOKEN_BEARER1)
    print(status, data)
    assert status == 401
