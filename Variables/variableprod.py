...
BASE_URL = "https://api.sondeservices.com/platform/v1"
BASE_URL2 = "https://api.sondeservices.com/platform/v2"

#host_url = "https://d2yh7ouv34mvzw.cloudfront.net/platform/v1"
ASYNC_URL= "https://api.sondeservices.com/platform/async/v1"
#---------------------------------------------------------
#Shruti's client credentials with questionnaire attached

CLIENT_ID_Shruti = '1mmfqd7r0qmo63j55ajqbh4s6k'
CLIENT_SECRET_Shruti = '175q9aei8tqfap74tohedr2aff2uhubn1nd7vokh8jn49uooln8t'

#---------------------------------------------------------
#---Below are the test parties---#
...
TC3_FILE_PATH2= 'C:\\Users\\gs-1431\\Downloads\\Two_sample_scoring_api\\Unreliable_score\\filestouse\\secondfile.wav'
